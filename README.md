...
![UI](https://img.shields.io/badge/UI-Jetpack_Compose-4285F4?style=for-the-badge&logo=jetpackcompose&logoColor=white)

This repository is a central hub for my Android development journey. It features a diverse range of applications, from agricultural logistics tools to advanced network diagnostic utilities.
...
* **The Problem:** Manual tracking of sugarcane loading is prone to errors in weight calculation.
...
| **UI Frameworks** | Jetpack Compose, Material 3, XML Layouts |
| **Architecture** | MVVM, LiveData, ViewModels |
| **Persistence** | Room Database, SQLite, Shared Preferences |
